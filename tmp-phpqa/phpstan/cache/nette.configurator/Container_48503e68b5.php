...
class Container_48503e68b5 extends _PHPStan_cc8d35ffb\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_48503e68b5 $container)
			{
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0145'), $this->getService('0146'), false, true, false);
	}
	...
	public function createServiceContainer(): Container_48503e68b5
	{
		return $this;
	}
